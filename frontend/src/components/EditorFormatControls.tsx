    ...
    return (
        <div className='editor-format-controls'>
            <div className='button-group'>
                ...
                <button className={btn('button-right')} disabled={disabled} onClick={() => handleFormat('strikethrough')}><s>S</s></button>
            </div>
            <div className='button-group'>
            ...
            <div className='button-group'>
                <button className={btn('button-left')} disabled={disabled}><span className='material-symbols-outlined'>format_color_text</span></button>
                <button className={btn('button-middle')} disabled={disabled} onClick={() => handleFormat('highlight')}><span className='material-symbols-outlined'>ink_highlighter</span></button>
                <button className={btn('button-right')} disabled={disabled} onClick={() => handleFormat('clear')}><span className='material-symbols-outlined'>format_clear</span></button>
            </div>
            <div className='button-group'>
