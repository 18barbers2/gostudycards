...
export const MOCK_TEMPLATES: CardTemplate[] = [
  ...
  <div style="font-size:1.6rem;color:white;font-weight:300;">{{English}}</div>
        ...
        style: '',
        createdAt: ALWAYS_DUE,
        updatedAt: ALWAYS_DUE,
        fields: [
...
export const MOCK_CARDS: CardEntry[] = [
    // ── Deck 1 · Japanese JLPT N5 (Kanji / Romaji / English split) ───────────
    {
        ...
        templateId: 'tmpl-1',
        deckId: '1',
        data: { Kanji: '猫', Romaji: 'neko', English: 'cat' },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
        reviewCount: 0,
    },
    {
        ...
        templateId: 'tmpl-1',
        deckId: '1',
        data: { Kanji: '犬', Romaji: 'inu', English: 'dog' },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
        reviewCount: 0,
    },
    {
        ...
        templateId: 'tmpl-1',
        deckId: '1',
        data: { Kanji: '水', Romaji: 'mizu', English: 'water' },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
        reviewCount: 0,
    },
    {
        ...
        templateId: 'tmpl-1',
        deckId: '1',
        data: { Kanji: '食べる', Romaji: 'taberu', English: 'to eat' },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
        reviewCount: 0,
    },
    {
        ...
        templateId: 'tmpl-1',
        deckId: '1',
        data: { Kanji: '学校', Romaji: 'gakkou', English: 'school' },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
        reviewCount: 0,
    },
    {
        ...
        templateId: 'tmpl-1',
        deckId: '1',
        data: { Kanji: '電車', Romaji: 'densha', English: 'train' },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
        reviewCount: 0,
    },
    {
        ...
        templateId: 'tmpl-1',
        deckId: '1',
        data: { Kanji: '友達', Romaji: 'tomodachi', English: 'friend' },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
        reviewCount: 0,
    },
    {
        ...
        templateId: 'tmpl-1',
        deckId: '1',
        data: { Kanji: 'ありがとう', Romaji: 'arigatou', English: 'thank you' },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
        reviewCount: 0,
    ...
    // ── Deck 2 · Spanish Verbs (Ending field added) ───────────────────────────
    {
        ...
        data: {
            Verb: 'hablar',
            Ending: '-ar',
            Conjugation: 'hablo, hablas, habla',
            Meaning: 'to speak',
        },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
    ...
    },
    {
        ...
        templateId: 'tmpl-2',
        deckId: '2',
        data: { Verb: 'comer', Ending: '-er', Conjugation: 'como, comes, come', Meaning: 'to eat' },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
        reviewCount: 0,
    ...
    // ── Deck 3 · Calculus I ───────────────────────────────────────────────────
    {
        ...
        templateId: 'tmpl-3',
        deckId: '3',
        data: { Rule: 'Power Rule', Formula: 'd/dx[xⁿ] = nxⁿ⁻¹', Example: 'd/dx[x³] = 3x²' },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
        reviewCount: 0,
    ...
    // ── Deck 4 · World Capitals (Continent field added) ───────────────────────
    {
        ...
        templateId: 'tmpl-4',
        deckId: '4',
        data: { Country: 'France', Continent: 'Europe', Capital: 'Paris' },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
        reviewCount: 0,
    },
    {
        ...
        templateId: 'tmpl-4',
        deckId: '4',
        data: { Country: 'Japan', Continent: 'Asia', Capital: 'Tokyo' },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
        reviewCount: 0,
    },
    {
        ...
        templateId: 'tmpl-4',
        deckId: '4',
        data: { Country: 'Brazil', Continent: 'S. America', Capital: 'Brasília' },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
        reviewCount: 0,
    },
    {
        ...
        templateId: 'tmpl-4',
        deckId: '4',
        data: { Country: 'Australia', Continent: 'Oceania', Capital: 'Canberra' },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
        reviewCount: 0,
    },
    {
        ...
        templateId: 'tmpl-4',
        deckId: '4',
        data: { Country: 'Canada', Continent: 'N. America', Capital: 'Ottawa' },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
        reviewCount: 0,
    },
    {
        ...
        templateId: 'tmpl-4',
        deckId: '4',
        data: { Country: 'Egypt', Continent: 'Africa', Capital: 'Cairo' },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
        reviewCount: 0,
    ...
    // ── Deck 5 · Medical Terminology (Type field added) ───────────────────────
    {
        ...
        data: {
            Term: 'cardio-',
            Type: 'prefix',
            Definition: 'relating to the heart (e.g. cardiovascular)',
        },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
    ...
    },
    {
        ...
        templateId: 'tmpl-5',
        deckId: '5',
        data: { Term: '-itis', Type: 'suffix', Definition: 'inflammation (e.g. appendicitis)' },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
        reviewCount: 0,
    },
    {
        ...
        data: {
            Term: '-ectomy',
            Type: 'suffix',
            Definition: 'surgical removal (e.g. appendectomy)',
        },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
    ...
    },
    {
        ...
        data: {
            Term: 'hyper-',
            Type: 'prefix',
            Definition: 'above normal, excessive (e.g. hypertension)',
        },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
    ...
    },
    {
        ...
        data: {
            Term: 'hypo-',
            Type: 'prefix',
            Definition: 'below normal, deficient (e.g. hypoglycemia)',
        },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
    ...
    },
    {
        ...
        templateId: 'tmpl-5',
        deckId: '5',
        data: { Term: '-ology', Type: 'suffix', Definition: 'study of (e.g. cardiology)' },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
        reviewCount: 0,
    ...
    },
    {
        ...
        data: {
            Concept: 'Dictionary',
            Explanation: 'Key-value pairs, mutable and unordered',
            Example: 'd = {"key": "value"}',
        },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
    ...
    },
    {
        ...
        data: {
            ...
            Explanation: 'Anonymous single-expression function',
    ...
    },
    {
        ...
        data: {
            Concept: 'Decorator',
            Explanation: 'Function that wraps another to extend behaviour',
    ...
    // ── Deck 7 · Classical Music (Era moved to its own field) ─────────────────
    {
        ...
        data: {
            ...
            Era: 'Baroque',
            'Notable Works': 'Brandenburg Concertos, The Well-Tempered Clavier',
        },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
    ...
    },
    {
        ...
        data: {
            ...
            Era: 'Classical',
            'Notable Works': 'Symphony No. 40, The Magic Flute',
        },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
    ...
    },
    {
        ...
        data: {
            ...
            Era: 'Romantic',
            'Notable Works': 'Nocturnes, Ballade No. 1',
        },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
    ...
    },
    {
        ...
        data: {
            ...
            Era: 'Impressionist',
            'Notable Works': 'Clair de lune, La Mer',
        },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
    ...
    // ── Deck 8 · French Food Vocabulary ──────────────────────────────────────
    {
        ...
        templateId: 'tmpl-8',
        deckId: '8',
        data: { French: 'le pain', English: 'bread' },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
        reviewCount: 0,
    },
    {
        ...
        templateId: 'tmpl-8',
        deckId: '8',
        data: { French: 'le fromage', English: 'cheese' },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
        reviewCount: 0,
    },
    {
        ...
        templateId: 'tmpl-8',
        deckId: '8',
        data: { French: 'la viande', English: 'meat' },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
        reviewCount: 0,
    },
    {
        ...
        templateId: 'tmpl-8',
        deckId: '8',
        data: { French: 'les légumes', English: 'vegetables' },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
        reviewCount: 0,
    },
    {
        ...
        templateId: 'tmpl-8',
        deckId: '8',
        data: { French: "l'addition", English: 'the bill (restaurant)' },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
        reviewCount: 0,
    },
    {
        ...
        templateId: 'tmpl-8',
        deckId: '8',
        data: { French: 'bien cuit', English: 'well done (cooking)' },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
        reviewCount: 0,
    ...
    // ── Deck 9 · US History (Century field added) ─────────────────────────────
    {
        ...
        data: {
            ...
            Year: '1776',
            Significance: 'Formally declared the 13 colonies independent from Britain',
        },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
    ...
    },
    {
        ...
        data: {
            ...
            Century: '18th century',
            Year: '1788',
            Significance: 'Established the framework of the US federal government',
        },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
    ...
    },
    {
        ...
        data: {
            ...
            Year: '1865',
            Significance: 'Preserved the Union and led to abolition of slavery',
        },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
    ...
    },
    {
        ...
        data: {
            ...
            Year: '1969',
            Significance: 'Apollo 11 — first humans on the Moon',
        },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
    ...
    // ── Deck 10 · German Articles (Gender field added) ────────────────────────
    {
        ...
        deckId: '10',
        data: {
            'Article + Noun': 'der Mann',
            Gender: 'masculine',
            Cases: 'Nom: der | Acc: den | Dat: dem | Gen: des',
        },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
    ...
    },
    {
        ...
        deckId: '10',
        data: {
            'Article + Noun': 'die Frau',
            Gender: 'feminine',
            Cases: 'Nom: die | Acc: die | Dat: der | Gen: der',
        },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
    ...
    },
    {
        ...
        deckId: '10',
        data: {
            'Article + Noun': 'das Kind',
            Gender: 'neuter',
            Cases: 'Nom: das | Acc: das | Dat: dem | Gen: des',
        },
        nextReviewAt: ALWAYS_DUE,
        interval: 1,
        easeFactor: 2.5,
