    ...
    return (
        <Layout>
            <div className="decks-page">
                ...
                <p>
                    This is the Decks page. Here you will be able to view and manage your decks of
                    cards.
                </p>
                <div className="decks">
                    {loading ? (
                        ...
                        <>
                            ...
                            <div className="deck-tile-skeleton">
                                <div
                                    className="skeleton deck-tile-skeleton__title"
                                    style={{ width: '50%' }}
                                />
                                <div
                                    className="skeleton deck-tile-skeleton__sub"
                                    style={{ width: '30%' }}
                                />
                            </div>
                            <div className="deck-tile-skeleton">
